...
// описываем функцию для смены темы на белую
...
// описываем функцию для смены темы на классическую (черно-белую)
...
// создаём окно для выбора темы приложения по клику на кнопку для вызова этого окна (картинка палитры)
